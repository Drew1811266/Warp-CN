...
- RC38 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains evidence-gated. RC38 adds `docs/zh-Hans-localization-phase276.md` through `docs/zh-Hans-localization-phase283.md`, `docs/zh-Hans-release-candidate-2026-06-03-rc38.md`, offline redacted evidence candidate preflight, candidate JSON/Markdown renderers, RC38 candidate docs, runbook preflight-command refresh, lane readiness refresh, and a heat-safe heavy validation pass. Current public-RC blocker total is 11, and ready evidence rows remain 0.
- RC37 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains evidence-gated. RC37 adds `docs/zh-Hans-localization-phase268.md` through `docs/zh-Hans-localization-phase275.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc37.md`, prioritized public-RC evidence queue output, queue JSON/Markdown renderers, RC37 queue docs, runbook queue-command refresh, lane readiness refresh, and a heat-safe heavy validation defer. Current public-RC blocker total is 11, and ready evidence rows remain 0.
- Phase 276 records the post-RC37 baseline before adding redacted evidence candidate preflight output.
- RC36 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains evidence-gated. RC36 adds `docs/zh-Hans-localization-phase260.md` through `docs/zh-Hans-localization-phase267.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc36.md`, row/category filters for missing-action output, Markdown evidence action packets, RC36 action package docs, runbook filter-command refresh, lane readiness refresh, and a heat-safe heavy validation defer. Current public-RC blocker total is 11, and ready evidence rows remain 0.
- Phase 268 records the post-RC36 baseline before adding prioritized evidence queue output.
- RC35 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains evidence-gated. RC35 adds `docs/zh-Hans-localization-phase252.md` through `docs/zh-Hans-localization-phase259.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc35.md`, strict row-specific artifact path checks, JSON evidence report output, JSON missing-action output, RC35 evidence automation docs, lane readiness refresh, and a low-load-gated fresh bundle. Current public-RC blocker total is 11, and ready evidence rows remain 0.
- Phase 260 records the post-RC35 baseline before adding filtered evidence action packets.
- RC34 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains evidence-gated. RC34 adds `docs/zh-Hans-localization-phase244.md` through `docs/zh-Hans-localization-phase251.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc34.md`, row-level missing-action evidence output, strict artifact positive-path coverage, RC34 action/readiness packaging, asset/GUI dependency refresh, and a heat-gated heavy validation retry. Current public-RC blocker total is 11, and ready evidence rows remain 0.
- Phase 252 records the post-RC34 baseline before adding stricter row-path evidence checks and JSON report output.
- RC33 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains evidence-gated. RC33 adds `docs/zh-Hans-localization-phase236.md` through `docs/zh-Hans-localization-phase243.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc33.md`, public-RC evidence report/template helpers, strict-artifact linting, lane-readiness packaging, asset/GUI dependency recheck, and a heat-gated heavy validation retry. Current public-RC blocker total is 11, and ready evidence rows remain 0.
- Phase 244 records the post-RC33 baseline before adding row-level missing-action evidence output.
- RC32 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains evidence-gated. RC32 adds `docs/zh-Hans-localization-phase228.md` through `docs/zh-Hans-localization-phase235.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc32.md`, structured public-RC evidence intake linting, evidence metadata docs, lane reclassification, asset preflight, and a heat-gated heavy validation retry. Current public-RC blocker total is 11, and ready evidence rows remain 0.
- Phase 236 records the post-RC32 baseline before adding evidence report and packet helpers.
- RC31 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC31 evidence includes `docs/zh-Hans-localization-phase220.md` through `docs/zh-Hans-localization-phase227.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc31.md`, repeatable low-load gate helper and tests, heat-safe validation docs, helper-controlled heavy gate defer, current-cycle GUI defer, public-RC action package, publication readiness boundary, and final RC31 validation. Current public-RC blocker total is 11.
- Phase 228 records the post-RC31 baseline before adding structured public-RC evidence intake checks.
- RC30 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC30 evidence includes `docs/zh-Hans-localization-phase212.md` through `docs/zh-Hans-localization-phase219.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc30.md`, post-RC29 branch hygiene, heat-safe heavy validation defer, no-account GUI defer, isolated-account/backend-fixture/disposable-object prerequisite refreshes, PNG asset branch deferral, and final RC30 validation. Current public-RC blocker total is 11.
- Phase 220 records the post-RC30 branch baseline before adding a repeatable low-load gate helper.
- RC29 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC29 evidence includes `docs/zh-Hans-localization-phase200.md` through `docs/zh-Hans-localization-phase211.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc29.md`, post-RC28 branch-state settlement, non-destructive upstream stable retarget audit, local/remote stable tree-parity adoption, overlay-repair deferral because dry-run is clean, tag namespace policy, heat-safe fresh bundle skip, no-account GUI skip, public-RC blocker refresh, PNG asset branch deferral, and final RC29 validation. Current public-RC blocker total is 11. The current branch is source-tree equivalent to the current remote `v0.2026.05.27.09.22.stable_00` target, but it must not claim ancestry containment of the remote stable commit.
- Phase 212 records post-RC29 branch hygiene and confirms that integration or publication requires explicit user approval.
- RC28 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC28 evidence includes `docs/zh-Hans-localization-phase187.md` through `docs/zh-Hans-localization-phase199.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc28.md`, RC27 branch-state settlement, heat-safe fresh bundle skip, no-account GUI skip, isolated-account/backend-fixture/disposable-object blocker rechecks, Agent render evidence follow-up, PNG asset approval gate, upstream tag conflict audit, and final RC28 validation. Current public-RC blocker total is 11, and an upstream-sync follow-up is now required because the remote `v0.2026.05.27.09.22.stable_00` target differs from the local tag target.
- RC27 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC27 evidence includes `docs/zh-Hans-localization-phase177.md` through `docs/zh-Hans-localization-phase186.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc27.md`, RC26 baseline/drift confirmation, heat-safe fresh bundle and no-account GUI skip records, isolated-account/backend-fixture/disposable-object blocker rechecks, Agent lifecycle source-harness verification, onboarding PNG approval gate, upstream freshness decision, low-concurrency Rust compile evidence, and final RC27 validation. Current public-RC blocker total is 11.
- RC26 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC26 evidence includes `docs/zh-Hans-localization-phase165.md` through `docs/zh-Hans-localization-phase176.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc26.md`, RC25 baseline/drift confirmation, quiet-window gating, heat-safe compile/bundle/GUI skip records, Agent lifecycle source-anchor deferral, refreshed public-RC registry handoff, PNG asset gate, locale export readiness, evidence hygiene sweep, and final RC26 validation. Current public-RC blocker total is 11.
- RC25 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC25 evidence includes `docs/zh-Hans-localization-phase153.md` through `docs/zh-Hans-localization-phase164.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc25.md`, RC24 baseline/drift confirmation, heat-safe compile/bundle/GUI skip records, Agent lifecycle source-anchor deferral, refreshed public-RC registry, isolated account/backend/disposable blocker gates, PNG approval recheck, locale export readiness, and evidence hygiene sweep. Current public-RC blocker total is 11.
- RC24 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC24 evidence includes `docs/zh-Hans-localization-phase144.md` through `docs/zh-Hans-localization-phase152.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc24.md`, RC23 baseline/drift confirmation, heat-safe compile/bundle/GUI skip records, Agent lifecycle source-anchor deferral, refreshed public-RC prerequisites, PNG approval recheck, and evidence hygiene sweep. Current public-RC blocker total is 11.
- RC23 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC23 evidence includes `docs/zh-Hans-localization-phase135.md` through `docs/zh-Hans-localization-phase143.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc23.md`, heat-safe heavy/GUI skip records, refreshed public-RC prerequisites, PNG approval recheck, and evidence hygiene sweep. Current public-RC blocker total is 11.
- RC22 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC22 evidence includes `docs/zh-Hans-localization-phase127.md` through `docs/zh-Hans-localization-phase134.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc22.md`, and a debug/test-only `WARP_CN_AGENT_LIFECYCLE_SMOKE` model probe in `app/src/ai/ambient_agents/task.rs`.
- RC21 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC21 evidence includes `docs/zh-Hans-localization-phase119.md` through `docs/zh-Hans-localization-phase126.md`, `docs/zh-Hans-release-candidate-2026-06-02-rc21.md`, and a debug/test-only `WARP_CN_AGENT_LIFECYCLE_SMOKE` fixture seed helper in `app/src/ai/ambient_agents/task.rs`.
- RC20 decision: `ready-for-local-use-with-fixture-evidence`; public RC remains blocked. New RC20 evidence includes `resources/localization/zh-Hans-public-rc-blockers.toml`, `script/zh_public_rc_status.py`, `docs/zh-Hans-local-fixture-implementation-plan-rc20.md`, `docs/zh-Hans-onboarding-asset-authorization-rc20.md`, and `docs/zh-Hans-release-candidate-2026-06-02-rc20.md`.
...
GUI verification is tracked in `docs/zh-Hans-gui-smoke-matrix.md`. Use that matrix for release smoke status instead of relying on process startup, bundle success, or scattered manual-gate notes. For RC20 and later, public-RC blocker totals are summarized from `resources/localization/zh-Hans-public-rc-blockers.toml` with `script/zh_public_rc_status.py`. For RC32 and later, public-RC evidence metadata is tracked in `resources/localization/zh-Hans-public-rc-evidence.toml` and checked with `script/zh_public_rc_evidence_lint.py`. For RC33 and later, evidence readiness can be summarized with `script/zh_public_rc_evidence_report.py`; for RC34 and later, row-level missing evidence actions can be generated with `script/zh_public_rc_evidence_report.py --missing-actions`; for RC35 and later, JSON forms are available with `--json` and `--missing-actions-json`; for RC36 and later, use `--row-id` and `--category` with `--missing-actions`, `--missing-actions-json`, and `--missing-action-markdown` to produce scoped handoff packets; for RC37 and later, `script/zh_public_rc_evidence_queue.py` can produce prioritized queue output with `--json`, `--markdown`, `--row-id`, and `--category`; for RC38 and later, `script/zh_public_rc_evidence_candidate.py` can preflight a reviewed redacted evidence candidate with `--row-id`, `--artifact`, `--json`, and `--markdown` before any evidence ledger update is proposed.
...
The current RC38 record is `docs/zh-Hans-release-candidate-2026-06-03-rc38.md`. RC38 planning is tracked in `docs/superpowers/plans/2026-06-03-zh-Hans-post-rc37-roadmap.md`. RC37 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc37.md`, RC36 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc36.md`, RC35 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc35.md`, RC34 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc34.md`, RC33 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc33.md`, RC32 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc32.md`, RC31 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc31.md`, RC30 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc30.md`, RC29 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc29.md`, RC28 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc28.md`, RC27 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc27.md`, RC26 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc26.md`, RC25 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc25.md`, RC24 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc24.md`, RC23 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc23.md`, RC22 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc22.md`, RC21 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc21.md`, RC20 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc20.md`, RC19 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc19.md`, RC18 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc18.md`, RC17 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc17.md`, RC16 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc16.md`, RC15 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc15.md`, RC14 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc14.md`, RC13 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc13.md`, RC12 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc12.md`, RC11 remains in `docs/zh-Hans-release-candidate-2026-06-02-rc11.md`, RC10 remains in `docs/zh-Hans-release-candidate-2026-06-01-rc10.md`, RC9 remains in `docs/zh-Hans-release-candidate-2026-06-01-rc9.md`, RC8 remains in `docs/zh-Hans-release-candidate-2026-06-01-rc8.md`, RC7 remains in `docs/zh-Hans-release-candidate-2026-06-01-rc7.md`, RC6 remains in `docs/zh-Hans-release-candidate-2026-05-31-rc6.md`, RC5 remains in `docs/zh-Hans-release-candidate-2026-05-31-rc5.md`, RC4 remains in `docs/zh-Hans-release-candidate-2026-05-31-rc4.md`, RC3 remains in `docs/zh-Hans-release-candidate-2026-05-31-rc3.md`, RC2 remains in `docs/zh-Hans-release-candidate-2026-05-30-rc2.md`, and the earlier Phase 4 release-candidate record remains in `docs/zh-Hans-release-candidate-2026-05-30.md`.
