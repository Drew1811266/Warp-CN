...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        AgentTip {
            description: "使用 `/` 打开斜杠命令菜单并访问快速 Agent 操作。".to_string(),
        ...
        AgentTip {
            description: "使用 `/plan` <prompt> 先为 Agent 创建计划再执行。".to_string(),
        ...
        AgentTip {
            description: "使用 <keybinding> 打开命令面板，访问 Warp 操作和快捷键。".to_string(),
        ...
        AgentTip {
            description: "将可复用的工作流、Notebook 和提示词存入你的".to_string(),
        ...
        AgentTip {
            description: "输入新的提示词，可在 Agent 运行时重定向它。".to_string(),
            link: None,
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        ...
        AgentTip {
            description: "使用 <keybinding> 将上一条命令输出附加为 Agent 上下文。".to_string(),
        ...
        AgentTip {
            description: "使用 `/init` 索引仓库，让 Agent 理解你的代码库。".to_string(),
        ...
        AgentTip {
            description: "将图片拖入窗格，可作为 Agent 上下文附加。".to_string(),
        ...
        AgentTip {
            description: "提示 Agent 控制 node、python、postgres、gdb 或 vim 等交互式工具。".to_string(),
        ...
        AgentTip {
            description: "使用 `/add-mcp` 向工作区添加 MCP 服务器。".to_string(),
        ...
        AgentTip {
            description: "使用 `/create-environment` 将仓库转换为 Agent 可运行的远程 Docker 环境。".to_string(),
        ...
        AgentTip {
            description: "使用 `/add-prompt` 创建可复用提示词，以支持重复工作流。".to_string(),
            link: None,
            binding_name: None,
            action: None,
            kind: AgentTipKind::WarpDrive,
        ...
        AgentTip {
            description: "使用 `/add-rule` 创建全局 Agent 规则。".to_string(),
        ...
        AgentTip {
            description: "使用 `/fork` 创建当前对话的新副本，并可附加新的提示词。".to_string(),
            link: Some("https://docs.warp.dev/agent-platform/local-agents/interacting-with-agents/conversation-forking".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        ...
        AgentTip {
            description: "使用 `/new` 以干净上下文开始新的 Agent 对话。".to_string(),
        ...
        AgentTip {
            description: "使用 `/compact` 总结当前对话，并释放上下文窗口空间。".to_string(),
            link: None,
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        ...
        AgentTip {
            description: "使用 `/usage` 查看当前 AI 额度用量。".to_string(),
            link: None,
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        ...
        AgentTip {
            description: "使用 `oz` 命令以 headless 模式运行 Oz Agent，适合远程机器。".to_string(),
        ...
        AgentTip {
            description: "右键点击选中文本，可将其附加为 Agent 上下文。".to_string(),
            link: Some("https://docs.warp.dev/agent-platform/local-agents/agent-context/blocks-as-context#attaching-blocks-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        ...
        AgentTip {
            description: "使用 `AGENTS.md` 或 `CLAUDE.md` 应用项目范围规则。".to_string(),
        ...
        AgentTip {
            description: "粘贴 URL，可将该网页作为 Agent 上下文附加。".to_string(),
        ...
        AgentTip {
            description: "Warpify 远程 SSH 会话，以便在该环境中启用 Oz。".to_string(),
        ...
        AgentTip {
            description: "使用 `/init` 生成 `WARP.md` 文件，并为 Agent 定义项目规则。".to_string(),
            link: Some("https://docs.warp.dev/agent-platform/capabilities/rules".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        ...
        AgentTip {
            description: "使用 <keybinding> 在本会话剩余时间内自动批准 Agent 的命令和 diff。".to_string(),
        ...
        AgentTip {
            description: "启用桌面通知，当 Agent 需要你关注时即可收到提醒。".to_string(),
        ...
        AgentTip {
            description: "使用 <keybinding> 取消当前 Agent 任务。".to_string(),
            link: None,
...
pub fn get_agent_tips(ctx: &AppContext) -> Vec<AgentTip> {
    ...
    {
        tips.push(AgentTip {
            description: "按住 <keybinding> 可直接对 Agent 说出你的提示词。".to_string(),
            link: Some(
