...
const DISABLE_SHELL_DEBUG_MODE_MENU_ITEM_NAME: &str = "为新会话停用 Shell 调试模式 (-x)";
const ENABLE_IN_BAND_GENERATORS_MENU_ITEM_NAME: &str = "为新会话启用带内生成器";
const DISABLE_IN_BAND_GENERATORS_MENU_ITEM_NAME: &str = "为新会话停用带内生成器";
const ENABLE_PTY_RECORDING: &str = "启用 PTY 录制模式 (warp.pty.recording)";
const DISABLE_PTY_RECORDING: &str = "停用 PTY 录制模式 (warp.pty.recording)";
