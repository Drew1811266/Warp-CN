...
impl FromStr for SettingsSection {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "About" | "关于" => Ok(Self::About),
            "Account" | "账号" => Ok(Self::Account),
            "AI" | "Agent" => Ok(Self::AI),
            "MCP Servers" => Ok(Self::MCPServers),
            "BillingAndUsage" | "账单和用量" => Ok(Self::BillingAndUsage),
            "Appearance" | "外观" => Ok(Self::Appearance),
            "Code" | "代码" => Ok(Self::Code),
            "Features" | "功能" => Ok(Self::Features),
            "Keybindings" | "键盘快捷键" => Ok(Self::Keybindings),
            "Privacy" | "隐私" => Ok(Self::Privacy),
            "Referrals" | "推荐" => Ok(Self::Referrals),
            "Scripting" | "脚本" => Ok(Self::Scripting),
            "Shared blocks" | "SharedBlocks" | "共享块" => Ok(Self::SharedBlocks),
            "Teams" | "团队" => Ok(Self::Teams),
            ...
            "CloudEnvironments" | "环境" => Ok(Self::CloudEnvironments),
